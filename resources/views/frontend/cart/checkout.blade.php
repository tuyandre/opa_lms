            ...
            <div class="checkout-content">
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        @if(count($courses) > 0)
                            @if((config('services.stripe.active') == 0) && (config('paypal.active') == 0) && (config('payment_offline_active') == 0) && (config('services.instamojo.active') == 0) && (config('services.razorpay.active') == 0))
