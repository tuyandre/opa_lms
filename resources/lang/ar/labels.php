...
return [
    'backend' => [
        ...
        'backup' => [
            ...
            'backup_note' => '<b> ملاحظة </b>: لتشغيل هذه النسخة الاحتياطية بشكل صحيح ، يلزمك إضافة الكود التالي إلى <b> CRON TAB: </b> <br> <code> * * * * * cd / path-to-your -المشروع && php جدولة الحرفيين: تشغيل >> / dev / null 2> & 1 </code>',
...
<p class = "mb-1"> <b> تضمين: </b> نسخ / لصق رمز التضمين في مربع النص أعلاه </ p>',
            'view' => 'عرض الدروس',
            'vimeo_note' => '<b> تعليمات لإضافة رابط فيديو: </ b> <br> انتقل إلى vimeo -> فيديو مفتوح -> انقر بزر الماوس الأيمن على الفيديو و <b> نسخ عنوان URL للفيديو </ b> والصقه هنا. <br> إذا كنت تريد لإضافة مقاطع فيديو متعددة ، قم بفصلها باستخدام علامة <b> و </b> (فاصلة).',
            'yt_note' => '<b> تعليمات لإضافة رابط فيديو: </ b> <br> انتقل إلى youtube -> open video -> انقر بزر الماوس الأيمن على الفيديو و <b> نسخ عنوان URL للفيديو </b> والصقه هنا. <br> إذا كنت تريد لإضافة مقاطع فيديو متعددة ، قم بفصلها باستخدام علامة <b> و </b> (فاصلة).',
        ],
        'pages' => [
            'fields' => [
                'slug' => 'سبيكة',
        ...
        'dashboard' => [
            ...
            'review' => 'إعادة النظر',
            'students' => 'الطلاب',
            'students_enrolled' => 'التحق الطلاب بـ <be> الدورات التدريبية الخاصة بك',
            'teachers' => 'معلمون',
            'time' => 'زمن',
            'title' => 'لوحة القيادة',
            'trending' => 'الشائع',
        ...
        'general_settings' => [
            ...
            'captcha' => 'سواء كان التسجيل - تسجيل الدخول captcha أو إيقاف تشغيله',
            ...
            'contact' => [
                ...
                'map_note' => '<h3> كيفية تضمين موقع للخريطة؟ </ h3>
                                <p> اتبع الخطوات البسيطة وأنت على ما يرام: </ p>
                                <ol class = "map-guide">
                                    <li> انتقل إلى <a class="text-bold" target="_blank" href="//maps.google.com"> خريطة Google </a> </li>
                                    <li> ابحث في المكان الذي تريد إضافته عن طريق إدخال العنوان / الموقع في مربع الإدخال الموجود في الزاوية العلوية اليسرى </ li>
                                    <li> بمجرد حصولك على المكان الذي تريده. هذا يظهر التفاصيل في الشريط الجانبي الأيسر. انقر فوق <i class = "fa fa-share-alt text-primary"> </i> زر </li>
...
                                    <li> انقر الآن على القائمة المنسدلة من اليسار. بشكل افتراضي ، يتم تحديد <b> متوسط ​​</b>. انقر عليها واختر <b> كبير </ b> </li>
                                    <li> الآن انقر على <b class = "text-primary"> رابط COPY HTML </b> منه و <b> لصق </b> هذا الرمز هنا في <b> الموقع على الخريطة </ b>. < / لى>
                                </ OL>',
            ...
            'email' => [
                ...
                'mail_username_note' => 'أضف بريدك الإلكتروني إذا كنت تريد التهيئة لإرسال رسائل البريد الإلكتروني',
                'note' => '<b> ملاحظة مهمة </ b>: إذا كنت تستخدم <b> GMAIL </b> لتكوين البريد ، فتأكد من إكمال العملية التالية قبل التحديث:
 <UL>
<li> انتقل إلى <a target="_blank" href="https://myaccount.google.com/security">My حسابي </a> من حسابك في Google الذي تريد تكوينه وتسجيل الدخول </ li>
<li> قم بالتمرير لأسفل إلى <b> وصول أقل أمانًا للتطبيق </ b> وتعيينه <b>ON</b> </li>
            ...
            'newsletter' => [
                'api_key' => 'مفتاح API',
                'api_key_note' => 'قم بإنشاء <b> مفتاح API </b> من <a target="_blank" href="https://mailchimp.com/"><b> <b> حساب Mailchimp </b> </a> والصقه في أعلاه مربع الكتابة.',
                'api_key_note_sendgrid' => 'قم بإنشاء <b> مفتاح API </b> من <a target="_blank" href="https://sendgrid.com/"><b> <b> حساب SendGrid </b> </a> والصقه في أعلاه مربع الكتابة.',
...
<b> Live </b> = سيتم استخدام بيانات اعتماد Live PayPal معك لإجراء معاملات فعلية مع مستخدمين عاديين لديهم حساب PayPal.',
            ...
            'total_students' => 'أدخل مجموع الطلاب. على سبيل المثال: 1K ، 1 مليون ، 1000 إلخ.',
        ...
        'logo' => [
            ...
            'logo_b' => 'الشعار 1',
            'logo_b_note' => 'ملاحظة: تحميل الشعار مع <b> نص أسود وخلفية شفافة بتنسيق .png </b> و <b> 294 × 50 </b> (WxH) بكسل. <br> <b> الارتفاع </ b> يجب أن تكون ثابتة ، <b> العرض </ b> وفقًا لـ <b> نسبة العرض إلى الارتفاع </ b>.',
            'logo_popup' => 'شعار للنوافذ المنبثقة',
            'logo_popup_note' => 'ملاحظة: أضف دقة شعار مربعة <b> 72 × 72 </b> بكسل',
            'logo_w' => 'الشعار 2',
            'logo_w_note' => 'ملاحظة: تحميل الشعار مع <b> نص أبيض وخلفية شفافة بتنسيق .png </b> و <b> 294 × 50 </b> (WxH) بكسل. <br> <b> الارتفاع </ b> يجب أن تكون ثابتة ، <b> العرض </ b> وفقًا لـ <b> نسبة العرض إلى الارتفاع </ b>.',
            'logo_white' => 'الشعار 3',
...
                            تحديث المجموعات!',
            ...
            'import_groups_note' => '<p> سيؤدي هذا إلى الحصول على جميع ملفات الإعدادات المحلية من مجلد <code> lang </code> وإدراجها في قاعدة البيانات. <br> <b> إلحاق ترجمات جديدة: </ b> سيُلحق فقط الملفات والبيانات الجديدة <b> & amp ؛ </ B>
...
                        <p> إذا كنت تقوم بالتحميل مباشرة من مربع إدخال الملف أدناه ، فسيتم استبدال ملفاتك. نوصي بشدة بالقيام بذلك الاستبدال اليدوي للملفات واحدًا تلو الآخر أو تعديل التغييرات من خلال مقارنة الملف الذي تم تعديله الحالي والملفات الجديدة المحدثة.
                        <p> إذا كنت لا تزال تعاني من الارتباك. يرجى الاتصال بنا ، وسوف نوجهك لتحديث التطبيق الخاص بك </ p>',
    ...
    'frontend' => [
        ...
        'contact' => [
            ...
            'send_us_a_message' => 'أرسل لنا رسالة <span>. </span>',
            'title' => 'اتصل',
        ...
        'course' => [
            ...
            'enrolled' => 'المقيدين',
            'featured' => 'متميز',
            'featured_course' => 'دورة <span> مميزة </ span>',
        ...
        'modal' => [
            ...
            'login_register' => '<a href="#" class="font-weight-bold go-login px-0"> LOGIN </a> إلى موقعنا على الويب ، أو <a href = "#" class = "font-weight-bold go- قم بالتسجيل px-0 "id =" "> تسجيل </a>',
            'my_account' => 'حسابي',
