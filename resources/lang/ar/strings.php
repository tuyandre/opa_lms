...
return array (
  ...
  array (
    ...
    array (
      ...
      'drag_instruction_2' => 'الرجاء إدخال الاسم وتحديد زر "إنشاء قائمة"',
      'edit' => 'تصحيح',
  ...
  array (
    ...
    array (
      ...
      'using_access_helper' => 
      array (
        'array_permissions' => 'استخدام مساعد الوصول مع مجموعة من أسماء التصاريح أو المعرفات حيث يجب على المستخدم امتلاك كل شيء.',
        'array_permissions_not' => 'استخدام مساعد الوصول مع مجموعة من أسماء التصاريح أو المعرفات حيث لا يتعين على المستخدم امتلاك الكل',
      ...
      'you_can_see_because_permission' => 'يمكنك رؤية ذلك لأنك حصلت على إذن من: :permission!',
      'you_can_see_because' => 'يمكنك أن ترى هذا لأن لديك دور " :role"',
      'view_console_it_works' => 'عرض وحدة التحكم ، سترى "إنه يعمل!" الذي يأتي من FrontendController @ index',
    ...
    array (
      ...
      'change_email_notice' => 'يجب تأكيد عنوان بريدك الإلكتروني الجديد قبل أن تتمكن من تسجيل الدخول مرة أخرى.',
      'email_changed_notice' => 'يجب تأكيد عنوان البريد الإلكتروني الجديد قبل أن تتمكن من تسجيل الدخول مرة أخرى.',
    ),
  ),
);
